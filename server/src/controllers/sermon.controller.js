...
export const createSermon = async (req, res) => {
  try {
    ...
    res
      .status(201)
      .json({ message: "Sermon created", success: true, data: sermon });
  } catch (error) {
...
export const getSermonById = async (req, res) => {
  try {
    ...
    if (!sermon) {
      return res
        .status(404)
        .json({ message: "Sermon not found", success: false });
    }

    logger.info("Fetched sermon:", sermon._id);
    res
      .status(200)
      .json({ message: "Sermon fetched", success: true, data: sermon });
  } catch (error) {
...
export const updateSermon = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ message: "Sermon updated", success: true, data: sermon });
  } catch (error) {
